            ...
            <div className="detail-box">
              ...
              <div className="detail-text">
                <p>
                  ...
                  eksotis dan sepi. Keunikan pantai ini juga terletak pada
                  formasi batu-batu karang yang membingkai sepanjang garis
                  pantai, menciptakan lanskap yang menakjubkan dan menambah
                  pesona alamnya. Selain itu, Pantai Tanjung Belandang juga
                  menjadi tempat yang ideal untuk menyaksikan kehidupan burung
                  laut yang beragam, menjadikannya surga bagi para pengamat
                  burung. Pantai ini memiliki daya tarik ekologis yang tinggi,
                  dengan beberapa spesies tumbuhan dan binatang langka yang
                  hidup di sekitarnya.
                </p>
                <p>
                  Bagi para pelancong yang mencari petualangan, Pantai Tanjung
                  Belandang juga menjadi titik awal untuk menjelajahi
                  hutan-hutan yang masih alami dan pegunungan yang
                  mengelilinginya. Terdapat jalur-jalur trekking yang menawarkan
                  pemandangan alam yang menakjubkan dan memungkinkan pengunjung
                  untuk berinteraksi lebih dekat dengan keanekaragaman hayati di
                  sekitar pantai.
                </p>
                <p>
